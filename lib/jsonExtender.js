...
class jsonExtender {
   ...
   * Constructor 
   * 
   * @param {Object} options Instantiation option.
   * @param {String} options.filePath A full path to a file to be created with generated and static json files.
   * @param {String} options.generatedPath A path to the folder where generated files are stored.
   * @param {String} options.staticPath A path to the folder where static files are stored.
  ...
  extend(arr) {
    ...
    jsonConcat({
      src: [jsonData, ...files], dest: this.filePath
    }, (json) => {
